const Lsi = {
  appName: {
    cs: "Aplikace uuDatamanagement",
    en: "Application uuDatamanagement",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuDatamanagement",
      en: "About application uuDatamanagement",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuDatamanagement.",
      en: "You can buy your own uuDatamanagement.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuDatamanagement.",
      en: "You don't have rights to initialize this uuDatamanagement.",
    },
  },
