...
import uu.datamanagement.main.abl.entity.CountryNode;
...
public class GskDocumentParser extends AbstractXmlParser<GskDocument> {
  ...
  protected Map<String, Consumer<XMLEvent>> getEventList() {
    ...
    eventList.put("GSKDocument/GSKSeries/ManualGSK_Block/GSK_Name", e -> this.currentSeries.getManualGskBlocks().add(new ManualGskBlock(getV(e))));
    ...
    eventList.put("GSKDocument/GSKSeries/CountryGSK_Block/GSK_Name", e -> this.currentSeries.getCountryGskBlocks().add(new CountryGskBlock(getV(e))));
    ...
    eventList.put("GSKDocument/GSKSeries/CountryGSK_Block/CountryNodes/NodeName", e -> this.currentSeries.getLastCountryBlock().getCountryNodes().add(new CountryNode(getV(e))));
    return eventList;
  }
